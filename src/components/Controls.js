...
<>
  ...
  <img className="homepage-bg" src={iconimage} width="300px" height="150px" alt="Logo" style={{ width:'30vw', height:'', filter:'drop-shadow(2px 2px 2px #000)', background:'transparent !important', position:'relative', bottom:'20vh'}} />
